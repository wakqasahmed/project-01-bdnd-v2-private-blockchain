# Project 01. Private Blockchain Application

This is project 1 of Blockchain Developer Nanodegree (V2) at Udacity. In this project, I have implemented the required functionality for the private blockchain using NodeJS.

## Udacity Review

https://review.udacity.com/#!/reviews/3516464

## Caveat

Bitcoin-Qt (a.k.a. Bitcoin Core) version v0.21.0 desktop application (which I used) generates segwit wallet address, however, transaction signing module supports legacy wallet address.

To fix this, I used Console command to generate the wallet address as follows:
<img width="794" alt="Screen Shot 2022-05-18 at 11 03 16 AM" src="https://user-images.githubusercontent.com/4486133/169138908-ef20b80e-e142-4822-94ca-e9b5228d04f4.png">
